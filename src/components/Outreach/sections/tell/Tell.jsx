  ...
  return (
    <>
      ...
      <section className="pt-[70px] px-8 bg-white">
        ...
        {/* THE IDEA */}
        <motion.div 
          className="w-full mb-20 flex flex-col lg:flex-row items-center gap-8"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={fadeUp}
        >
          <div className="flex-1">
            <h2 className="pb-4 text-2xl font-bold text-gray-800">THE IDEA:</h2>
...
Largely inspired by Dr. Bennett Goldberg’s Inclusive STEM class and other related small courses and workshops organized by the Searle center, we designed a learning environment for local high school students to come in on a Saturday and spend several hours getting familiar with some basic terms in protein biochemistry and having a hands-on experience in affinity protein purification and gel electrophoresis. We piloted this program with 7 ETHS female students, receiving positive feedback from all participants. As part of the learning experience, we kept all participants connected via Slack and provided them with a two-line blurb on the hands-on skills they have practiced (to include in their CVs) as well as a list of resources for other similar research opportunities to take advantage of and leverage towards future college applications, bettering their prospects in joining research labs as undergrads.x
          ...
          <motion.img 
            src={image1} 
            alt="" 
            className="flex-1 w-[50%] rounded-2xl shadow-lg hover:scale-[1.02] transition-transform duration-300"
        ...
        {/* THE IMPLEMENTATION */}
        <motion.div 
          className="w-full mb-20 flex flex-col lg:flex-row-reverse items-center gap-8"
          initial="hidden"
          whileInView="visible"
          variants={fadeUp}
        >
          <div className="flex-1">
            <h2 className="pb-4 text-2xl font-bold text-gray-800">THE IMPLEMENTATION:</h2>

            <p className="pb-2 text-lg leading-relaxed text-gray-700">
          ...
          <motion.img 
            src={image2} 
            alt="" 
            className="flex-1 w-1/2 rounded-2xl shadow-lg"
            whileHover={{ scale: 1.05 }}
          />
        </motion.div>
        ...
        {/* THE OUTCOME */}
        <motion.div 
          className="w-full mb-20 space-y-8"
          initial="hidden"
          whileInView="visible"
          variants={fadeUp}
        >
          <h2 className="pb-4 text-2xl font-bold text-gray-800">THE OUTCOME:</h2>
          <p className="text-lg leading-relaxed text-gray-700">
          ...
          <div className="flex flex-col lg:flex-row gap-5">
            <motion.img src={image3} className="flex-1 rounded-2xl shadow-lg h-[700px] object-cover" whileHover={{ scale: 1.05 }} />
            <motion.img src={image4} className="flex-1 rounded-2xl shadow-lg h-[700px] object-cover" whileHover={{ scale: 1.05 }} />
          </div>
        </motion.div>
        ...
        >
          ...
          />
          <div className="flex-1">
            <h2 className="pb-4 text-2xl font-bold text-gray-800">THE FUTURE:</h2>
            <p className="pb-2 text-lg leading-relaxed text-gray-700">
